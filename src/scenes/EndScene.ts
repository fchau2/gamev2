...
export class EndScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(width / 2, 180, "Level 1 Complete!", {
    ...
    this.add.text(width / 2, 272, "Great routing! You delivered all packets to the terminal.", {
      fontFamily: "Inter, sans-serif",
      fontSize: "24px",
      color: "#afcff6"
    }).setOrigin(0.5);

    this.add.text(width / 2, 332, `Packets Delivered: ${this.state.levelProgress.packetsDelivered}/3`, {
      fontFamily: "Inter, sans-serif",
      fontSize: "24px",
      color: "#d7ecff"
    }).setOrigin(0.5);

    const replay = this.add.rectangle(width / 2, 430, 260, 70, 0x68c5ff, 1)
    ...
    const menu = this.add.text(width / 2, 526, "Back to Menu", {
      fontFamily: "Inter, sans-serif",
      fontSize: "23px",
      color: "#9ac4ed"
